      ...
      <div>
        <ul>
          ...
          <li className='sub'>
            ...
            We pride ourselves on pushing the boundaries of digital design and development. <br></br>We combine relevant trends and best practices to build platforms with longevity.
            <div>
            </div>
          </li>
          <li className='sub'>
            <h1>Constant Growth</h1>
            Our team is composed of ambitious creatives and strategists; each member <br></br> is  dedicated to perfecting their craft and taking brands to the next level.
            <div>
            </div>
          </li>
          <li className='sub'>
            <h1>Well-Deserved Benefits</h1>
            Medical, dental, and vision coverage. Paid vacation, sick days, and a 401(k) plan. Sweeping <br></br> views  in the heart of Downtown San Jose. Dim sum and boba runs. Our team deserves it all.
          ...
          <li className='sub'>
            ...
            We sweat the small stuff, because we believe that the details make the design.<br></br> A time-tested and true platform values quality over quantity.        <div>
            </div>
          </li>
          <li className='sub'>
            <h1>Great Character</h1>
            More than skill, drive, or experience, great work is rooted in character; hiring the right <br></br> people and investing in personal development is essential to our growth.          <div>
            </div>
          </li>
          <li className='sub'> 
             <h1>Self-Starting</h1>
            Having an entrepreneurial mindset ensures that every member of our <br></br> team proudly takes ownership of each project, from concept to execution.        <div>
            </div>
          </li>
          <li className='sub'>
            <h1>Stay Humble</h1>
            We stand up for what we believe in, but never let ego get in the way. The <br></br> key to growth is to embrace feedback and from team members and clients.           <div>
            </div>
          </li>
          <li className='sub'>
            <h1>Work Hard, Play Hard</h1>
            Sometimes the late nights, early mornings, and long design sprints call for <br></br> strong drinks with good company. We value hard work and celebrate accordingly.         <div>
            </div>
          </li>
