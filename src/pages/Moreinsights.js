...
function Moreinsights() {
  return (
    <div>
      <p className='p1'>INSIGHTS</p>
      <h1 className='h1'>Perspectives on <br></br> digital and web.</h1>
      <p className='p2'>Our thoughts on creativity, <br></br>digital, and branding.</p>
